...
| Relying-party assessment | 接收方独立评估 | 接收方针对特定用途独立作出的适用性判断。 |
| Governed disposition | 逐项治理后的处置结果 | 针对单个能力声明、证据项或工作产物分别作出的结果，不是对整个人或整个案例作出的笼统所有权判断。 |

1. **留存在受保护环境中** — Retained in protected custody
2. **获准用于特定用途** — Authorized for specified use
3. **可由从业者在新场景继续使用的能力声明** — Worker-portable claim
