...
This repository is a discussion draft, not a standards organization. Its interim governance is designed to preserve criticism and prevent one interested party from presenting early consensus as legitimacy.

## Current authority

The repository maintainer administers files, discussions, and releases. Maintainer control is operational, not evidence that the charter has multi-stakeholder legitimacy.

## Decision process

1. Substantive feedback is recorded as a Discussion, Issue, or pull request.
2. Material objections are added to the public [objection register](feedback/objection-register.md).
