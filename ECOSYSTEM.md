...
The proposal is an ecosystem, not a single tool.
...
information, claim/evidence separation, procedural safeguards, appeal, and
remedy. It is the minimum floor against which every later component must be
tested.
...
The four dispositions apply to each governed object: the particular claim,
evidence item, or artifact receiving the decision. They do not assign one
outcome to an entire person, case, conversation, or file. One case can contain
objects with different dispositions:

- Retained in protected custody
- Authorized for specified use
- Worker-portable claim
