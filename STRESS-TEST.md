# The Worker-Offboarding Test for AI-Assisted Work

## Purpose

Find where this idea fails before asking anyone to support or build it.

## Scenario

Offboarding means the ending or material change of a work relationship, role,
or access. It does not mean retiring an AI system. A worker includes an
...
- No request to enable telemetry or endorse a product.
- No assumption that employment, custody, or participation determines ownership
  or authorization for an entire AI-assisted work record.
- No requirement for raw-memory portability.
- No implementation commitment.
- Do not disclose protected source material, confidential workplace examples,
  or personal data.
- Participation records a perspective; it does not imply endorsement.

## Decision after critique

Continue only if a multi-stakeholder group finds a real cross-industry gap and
believes the charter adds value beyond existing law, contracts, and standards.
Record objections and minority views in the decision-and-rationale register.
The result should be **continue**, **narrow**, **stop**, or **investigate**.
